...
{/* last name */}
        ...
        ="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
          ...
          ="h-5 w-5 text-gray-400" fill="none"
					...
					<input className
          ="pl-2 outline-none border-none" type="text" name="" id="" placeholder="Username"  onChange={(e) => setLastName(e.target.value)} />
      </div>
{/* email */}
					<div className
          ="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
      ...
      <div className
            ="flex items-center border-2 py-2 px-3 rounded-2xl">
              ...
              ="h-5 w-5 text-gray-400" viewBox="0 0 20 20"
							...
							<input className
              ="pl-2 outline-none border-none" type="text" name="" id="" placeholder="confirm password" onChange={(e) => setPassword(e.target.value)} />
      </div>
